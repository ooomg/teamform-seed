...
firebaseref.onAuth(authDataCallback);
*/
>>>>>>> 0f1484db7e03020f56d7685f07b78150716e0b86
  function toggleSignIn() {
    ...
    function togglefbSignIn() {
      ...
      // [START_EXCLUDE]
      document.getElementById('quickstart-fbsign-in').disabled = true;
      // [END_EXCLUDE]
    }
    // [END buttoncallback]
    //end_fbpart
    ...
    function initApp() {
      ...
      firebase.auth().onAuthStateChanged(function(user) {
        ...
        if (user) {
          ...
          document.getElementById('quickstart-fbsign-in').textContent = 'Log out';
          ...
          document.getElementById('quickstart-fbsign-in').textContent = 'Log in with Facebook';
      ...
      document.getElementById('quickstart-fbsign-in').addEventListener('click', togglefbSignIn, false);
